              ...
              >
                <div className="flex items-start gap-5 p-5">
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">{vt.description}</p>
        ...
        <div className="flex items-start gap-5 p-5">
          <div className="flex-1 min-w-0 space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-base font-bold text-zinc-100">{vt.label}</p>
                <p className="text-xs text-zinc-400 mt-0.5">{vt.segmentName}</p>
              </div>
            </div>
            <p className="text-sm text-zinc-300 leading-relaxed">{vt.description}</p>
            <div className="flex items-center gap-3 pt-1">
          ...
          {storyList.map((group) => {
            ...
            return (
              <div key={group.storyId} className="glass-card rounded-xl overflow-hidden">
                {/* Story header */}
                <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-800 glass-surface">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <BookOpen className="w-4 h-4 text-zinc-500 flex-shrink-0" />
                    <p className="text-sm font-semibold text-zinc-200 truncate">{group.storyTitle}</p>
                ...
                <div className="p-5 space-y-4">
                  {englishNotif?.image_url && (
                    <div className="rounded-lg overflow-hidden border border-zinc-800 max-w-md">
        ...
        return (
          <div key={vt.key} className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-sm font-semibold text-zinc-200">{vt.label}</h4>
              <span className="text-[10px] text-zinc-500">{vt.segmentName}</span>
            </div>
            {englishNotif?.image_url && (
              <div className="rounded-xl overflow-hidden border border-zinc-800 max-w-lg">
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="relative flex-1 max-w-xs">
          <select
            ...
            className="w-full appearance-none glass-card rounded-lg pl-3 pr-8 py-2.5 text-sm text-zinc-200 focus-neon cursor-pointer"
          >
